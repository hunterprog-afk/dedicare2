    ...
    <section id="filosofia" className="relative py-28 md:py-40 border-t border-border/40">
      <div className="max-w-[var(--max)] mx-auto px-[var(--gutter)]">
        ...
        <div className="text-center mb-16">
          ...
          <BlurText
            text="Non solo assistenza. Una presenza."
            as="h2"
          ...
          >
            Ogni dettaglio del nostro servizio è progettato per portare sollievo alla famiglia e dignità alla persona assistita.
          </motion.p>
        </div>
